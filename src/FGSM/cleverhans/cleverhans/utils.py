...
def pair_visual(*args, **kwargs):
  ...
  warnings.warn("`pair_visual` has moved to `cleverhans.plot.pyplot_image`. "
                ...
                "2019-04-24.")
  from src.FGSM.cleverhans.cleverhans.plot.pyplot_image import pair_visual as new_pair_visual
...
def grid_visual(*args, **kwargs):
  ...
  warnings.warn("`grid_visual` has moved to `cleverhans.plot.pyplot_image`. "
                ...
                "2019-04-24.")
  from src.FGSM.cleverhans.cleverhans.plot.pyplot_image import grid_visual as new_grid_visual
...
def get_logits_over_interval(*args, **kwargs):
  ...
  from src.FGSM.cleverhans.cleverhans.plot.pyplot_image import get_logits_over_interval as new_get_logits_over_interval
...
def linear_extrapolation_plot(*args, **kwargs):
  ...
  warnings.warn("`linear_extrapolation_plot` has moved to "
                ...
                "or after 2019-04-24.")
  # pylint:disable=line-too-long
  from src.FGSM.cleverhans.cleverhans.plot.pyplot_image import linear_extrapolation_plot as new_linear_extrapolation_plot
