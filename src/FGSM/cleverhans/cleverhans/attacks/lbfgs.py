...
from src.FGSM.cleverhans.cleverhans.compat import reduce_sum, softmax_cross_entropy_with_logits
from src.FGSM.cleverhans.cleverhans.model import CallableModelWrapper, Model, wrapper_warning
