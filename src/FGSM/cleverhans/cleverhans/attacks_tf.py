...
from src.FGSM.cleverhans.cleverhans.attacks.carlini_wagner_l2 import CWL2 as CarliniWagnerL2 # pylint: disable=unused-import
from src.FGSM.cleverhans.cleverhans.attacks.deep_fool import deepfool_batch, deepfool_attack # pylint: disable=unused-import
from src.FGSM.cleverhans.cleverhans.attacks.elastic_net_method import EAD as ElasticNetMethod # pylint: disable=unused-import
from src.FGSM.cleverhans.cleverhans.attacks.lbfgs import LBFGS_impl as LBFGS_attack # pylint: disable=unused-import
from src.FGSM.cleverhans.cleverhans.attacks.saliency_map_method import jsma_symbolic # pylint: disable=unused-import
from src.FGSM.cleverhans.cleverhans.attacks.spsa import TensorOptimizer, TensorGradientDescent, TensorAdam # pylint: disable=unused-import
from src.FGSM.cleverhans.cleverhans.attacks.spsa import SPSAAdam, margin_logit_loss, _apply_black_border # pylint: disable=unused-import
from src.FGSM.cleverhans.cleverhans.attacks.spsa import _apply_transformation, spm, parallel_apply_transformations # pylint: disable=unused-import
from src.FGSM.cleverhans.cleverhans.attacks.virtual_adversarial_method import vatm # pylint: disable=unused-import
from src.FGSM.cleverhans.cleverhans.utils_tf import jacobian_graph, jacobian_augmentation # pylint: disable=unused-import
...
def fgm(x, preds, *args, **kwargs):
  ...
  from src.FGSM.cleverhans.cleverhans.attacks import fgm as logits_fgm
...
def pgd_attack(*args, **kwargs):
  ...
  from src.FGSM.cleverhans.cleverhans.attacks import projected_optimization
